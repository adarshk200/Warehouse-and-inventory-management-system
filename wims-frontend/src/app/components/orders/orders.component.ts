...
@Component({
            ...
            <tbody>
              <tr *ngFor="let o of orders" class="table-row" [class.row-shipped]="o.status==='SHIPPED'" [class.row-cancelled]="o.status==='CANCELLED'">
                ...
                <td>
                  ...
                  <div class="product-sku">{{ o.product?.sku || '' }}</div>
                </td>
                <td>
                  <div class="warehouse-name">{{ o.warehouse?.name || '—' }}</div>
                  <div class="warehouse-loc">{{ o.warehouse?.location || '' }}</div>
                </td>
                <td>
                  <span class="qty-chip">× {{ o.quantity || 1 }}</span>
                </td>
                <td>
              ...
              <tr *ngIf="orders.length === 0">
                <td [attr.colspan]="canManage ? 8 : 7" class="empty-state">
  ...
  styles: [`
    ...
    .pipe-count { color: white; font-size: 1.75rem; font-weight: 800; line-height: 1; }
    ...
    .guide-step strong { color: white; font-size: 0.9rem; display: block; }
