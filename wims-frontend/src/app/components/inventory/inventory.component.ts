...
@Component({
  ...
  styles: [`
    ...
    .sum-val { font-size: 2rem; font-weight: 800; color: black; line-height: 1; }
    .sum-label { color: black; font-size: 0.85rem; margin-top: 0.25rem; text-transform: uppercase; letter-spacing: 0.5px; }
