...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        // 1. Seed Users (Admin, Warehouse Manager, Staff Manager)
        try {
    ...
    private void createProductAndInventory(String sku, String name, BigDecimal price, BigDecimal weight, Subcategory subcategory, Warehouse warehouse, int qty) {
